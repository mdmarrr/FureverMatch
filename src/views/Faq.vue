...
const questions = ref([
  { title: 'Why adopt instead of purchase?', answer: 'Adopting is nowadays the most responsible option. Every day, thousands of animals of various breeds and ages end up in shelters where they cannot receive the care they deserve. We understand that some people can only take care of small breeds or have specific preferences based on their lifestyle, but thanks to us, you can find the perfect match!' },
