...
export const useAnimalsStore = defineStore('animals', {
  ...
  actions: {
    ...
    getFilteredAnimals(filters: { species: string; sex: string; status: string; keyword: string }) {
        return this.animals.filter(animal => {
          return (
            ...
            animal.name.toLowerCase().includes(filters.keyword.toLowerCase()) || 
            (animal.description && animal.description.toLowerCase().includes(filters.keyword.toLowerCase()))
            )
          );
        });
    }
